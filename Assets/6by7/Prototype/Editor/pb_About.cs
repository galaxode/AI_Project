...
{
	public const string RELEASE_VERSION = "";
	const int REVISION_NO = 1471;
	const string BUILD_DATE = "12-16-2013";
	const string VELOCIRAPTOR_RISK = "";
	...
	public void OnGUI()
	{
		...
		GUILayout.BeginHorizontal();
			GUILayout.Label(": ", EditorStyles.boldLabel, GUILayout.MinWidth(LABEL_WIDTH), GUILayout.MaxWidth(LABEL_WIDTH));
